...
const (
	NFT_TX_TYPE_CASTING    = 1
	NFT_TX_TYPE_TRANSFER   = 2
	NFT_TX_TYPE_DESTORY    = 3
	NFT_TX_TYPE_ERROR      = 4
	NFT_TX_TYPE_IRRELEVANT = 5
)
